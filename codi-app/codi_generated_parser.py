...
cmd14 = subparsers.add_parser("Setcodi_status", help="Setcodi_status mode screen data1")
...
cmd24 = subparsers.add_parser(
    ...
    help="LoadLanguageResource langid resname resdata forcereload",
)
...
cmd32 = subparsers.add_parser(
    "ShowAlert",
    help="ShowAlert alertmode alertype alerticondata typestr resname seconds speed aftermode option1 option2",
)
...
cmd38 = subparsers.add_parser(
    "ContactInfo",
    help="ContactInfo contactid totalcontacts batchsize contactname msisdn",
)
...
cmd39 = subparsers.add_parser(
    "CallHistoryInfo",
    help="CallHistoryInfo cdrid totalcdr batchsize contactname msisdn day month year hour minute second tz state",
)
...
cmd40 = subparsers.add_parser(
    "NotificationInfo",
    help="NotificationInfo notid action appname shortinfo longinfo day month year hour minute second tz replyactions replyaction1 replyaction2 replyaction3",
)
...
cmd41 = subparsers.add_parser(
    "PlayerInfo",
    help="PlayerInfo appname artist album track offset length state imageadr",
)
