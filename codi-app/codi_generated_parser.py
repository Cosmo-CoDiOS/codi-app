...
cmd1 = subparsers.add_parser(
    "DateTimeInfo", help="DateTimeInfo day month year hour minute second tz")
...
cmd2 = subparsers.add_parser(
    "LocationStatusInfo", help="LocationStatusInfo status")
...
cmd5 = subparsers.add_parser(
    "WiFiStatusInfo", help="WiFiStatusInfo status signalval")
...
cmd7 = subparsers.add_parser(
    "BatterySaverStatusInfo", help="BatterySaverStatusInfo status")
cmd7.add_argument("status", type=int)

cmd8 = subparsers.add_parser(
    "FlightModeStatusInfo", help="FlightModeStatusInfo status")
cmd8.add_argument("status", type=int)

cmd9 = subparsers.add_parser(
    "HotspotStatusInfo", help="HotspotStatusInfo status")
cmd9.add_argument("status", type=int)

cmd10 = subparsers.add_parser(
    "MobileDataStatusInfo", help="MobileDataStatusInfo status")
cmd10.add_argument("status", type=int)

cmd11 = subparsers.add_parser(
    "DoNotDisturbStatusInfo", help="DoNotDisturbStatusInfo status")
cmd11.add_argument("status", type=int)

cmd12 = subparsers.add_parser(
    "VolumeLevelInfo", help="VolumeLevelInfo status stream")
cmd12.add_argument("status", type=int)
cmd12.add_argument("stream", type=int)

cmd13 = subparsers.add_parser(
    "BatteryLevelInfo", help="BatteryLevelInfo status")
cmd13.add_argument("status", type=int)

cmd14 = subparsers.add_parser(
    "SetCoDiStatus", help="SetCoDiStatus mode screen data1")
cmd14.add_argument("mode", type=int)
cmd14.add_argument("screen", type=int)
cmd14.add_argument("data1", type=int)

cmd15 = subparsers.add_parser(
    "LockStatusInfo", help="LockStatusInfo locked method strdata")
cmd15.add_argument("locked", type=int)
cmd15.add_argument("method", type=int)
cmd15.add_argument("strdata", type=str)

cmd16 = subparsers.add_parser(
    "CallMuteStatusInfo", help="CallMuteStatusInfo status")
...
cmd18 = subparsers.add_parser(
    "CallOutputOptionsInfo", help="CallOutputOptionsInfo output_options")
cmd18.add_argument("output_options", type=int)

cmd19 = subparsers.add_parser(
    "CameraStatusInfo", help="CameraStatusInfo status")
cmd19.add_argument("status", type=int)

cmd20 = subparsers.add_parser(
    "CameraSettingsInfo", help="CameraSettingsInfo parameter value")
...
cmd22 = subparsers.add_parser(
    "VideoSettingsInfo", help="VideoSettingsInfo parameter value")
cmd22.add_argument("parameter", type=int)
cmd22.add_argument("value", type=int)

cmd23 = subparsers.add_parser(
    "CoverLightSensorInfo", help="CoverLightSensorInfo value")
cmd23.add_argument("value", type=int)

cmd24 = subparsers.add_parser(
    "LoadLanguageResource", help="LoadLanguageResource langid resname resdata forcereload")
...
cmd26 = subparsers.add_parser(
    "SetCurrentLanguage", help="SetCurrentLanguage langid")
cmd26.add_argument("langid", type=str)

cmd27 = subparsers.add_parser(
    "ShowMedia", help="ShowMedia typestr resname seconds speed aftermode")
...
cmd28 = subparsers.add_parser(
    "StopMedia", help="StopMedia typestr resname aftermode")
cmd28.add_argument("typestr", type=str)
cmd28.add_argument("resname", type=str)
cmd28.add_argument("aftermode", type=int)

cmd29 = subparsers.add_parser(
    "LoadMedia", help="LoadMedia typestr resname resdata loadmode")
...
cmd30 = subparsers.add_parser(
    "UnloadMedia", help="UnloadMedia typestr resname")
...
cmd32 = subparsers.add_parser(
    "ShowAlert", help="ShowAlert alertmode alertype alerticondata typestr resname seconds speed aftermode option1 option2")
...
cmd35 = subparsers.add_parser(
    "ActionCoDiHome", help="ActionCoDiHome screenoff")
cmd35.add_argument("screenoff", type=int)

cmd36 = subparsers.add_parser(
    "NextAlarmInfo", help="NextAlarmInfo appid daystring timestr")
cmd36.add_argument("appid", type=int)
cmd36.add_argument("daystring", type=str)
cmd36.add_argument("timestr", type=str)

cmd37 = subparsers.add_parser(
    "ShowBatteryLevel", help="ShowBatteryLevel percentage showforseconds")
cmd37.add_argument("percentage", type=int)
cmd37.add_argument("showforseconds", type=int)

cmd38 = subparsers.add_parser(
    "ContactInfo", help="ContactInfo contactid totalcontacts batchsize contactname msisdn")
...
cmd39 = subparsers.add_parser(
    "CallHistoryInfo", help="CallHistoryInfo cdrid totalcdr batchsize contactname msisdn day month year hour minute second tz state")
...
cmd40 = subparsers.add_parser(
    "NotificationInfo", help="NotificationInfo notid action appname shortinfo longinfo day month year hour minute second tz replyactions replyaction1 replyaction2 replyaction3")
...
cmd41 = subparsers.add_parser(
    "PlayerInfo", help="PlayerInfo appname artist album track offset length state imageadr")
...
cmd42 = subparsers.add_parser(
    "CallInfo", help="CallInfo modem action contactid contactname msisdn hasicon")
...
cmd44 = subparsers.add_parser(
    "LEDisonPatternInfo", help="LEDisonPatternInfo animid animname animationdata")
cmd44.add_argument("animid", type=int)
cmd44.add_argument("animname", type=str)
cmd44.add_argument("animationdata", type=bytes)

cmd45 = subparsers.add_parser(
    "ContactIconInfo", help="ContactIconInfo contactid contactname msisdn icondata")
...
cmd46 = subparsers.add_parser(
    "ModemSignalInfo", help="ModemSignalInfo sim1 sim2 sim2type")
cmd46.add_argument("sim1", type=int)
cmd46.add_argument("sim2", type=int)
cmd46.add_argument("sim2type", type=int)

cmd47 = subparsers.add_parser(
    "WeatherInfo", help="WeatherInfo weatherstate temp scale additionaltext")
...
cmd48 = subparsers.add_parser(
    "ExtraCommand", help="ExtraCommand data1 data2 str1 str2")
...
cmd49 = subparsers.add_parser(
    "DateTimeFormat", help="DateTimeFormat dateformat timeformat")
...
cmd51 = subparsers.add_parser(
    "CameraFrameImage", help="CameraFrameImage width height png")
cmd51.add_argument("width", type=int)
cmd51.add_argument("height", type=int)
cmd51.add_argument("png", type=bytes)

cmd52 = subparsers.add_parser(
    "KeyPressInfo", help="KeyPressInfo keycode mode modifiers")
cmd52.add_argument("keycode", type=int)
cmd52.add_argument("mode", type=int)
cmd52.add_argument("modifiers", type=int)

cmd53 = subparsers.add_parser(
    "VoiceRecorderSettingsInfo", help="VoiceRecorderSettingsInfo parameter value")
cmd53.add_argument("parameter", type=int)
cmd53.add_argument("value", type=int)

cmd54 = subparsers.add_parser(
    "VoiceRecorderStatusInfo", help="VoiceRecorderStatusInfo status")
cmd54.add_argument("status", type=int)

cmd55 = subparsers.add_parser(
    "MTKDataChangeAlert", help="MTKDataChangeAlert type data1")
